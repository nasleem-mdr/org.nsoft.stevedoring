...
public class X_STEV_EquipmentDetail extends PO implements I_STEV_EquipmentDetail, I_Persistent
{
	...
	*/
	...
	/** RENT = RENT */
	public static final String OWNERSHIPTYPE_RENT = "RENT";
	/** Set OwnershipType.
	...
	*/
	...
	/** Set RentalContractNo.
		@param RentalContractNo RentalContractNo
	*/
	...
	/** Set RentalEndDate.
		@param RentalEndDate RentalEndDate
	*/
	...
	/** Set RentalRatePerDay.
		@param RentalRatePerDay RentalRatePerDay
	*/
	...
	/** Set RentalStartDate.
		@param RentalStartDate RentalStartDate
	*/
	...
	/** Set STEV_EquipmentDetail.
		@param STEV_EquipmentDetail_ID STEV_EquipmentDetail
	*/
